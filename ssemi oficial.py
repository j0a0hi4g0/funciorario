...
#######################################33###############################
    ...
    def buscar_livro(self):
        ...
        # Botão de busca
        botao_buscar = tk.Button(tela_buscar_livro, text="Buscar", command=lambda: self.realizar_busca(entry_busca.get()))
        botao_buscar.pack(pady=10)
    ...
    def listar_livros(self):
        # Código para listar todos os livros da biblioteca
        print("Listando todos os livros da biblioteca:")
